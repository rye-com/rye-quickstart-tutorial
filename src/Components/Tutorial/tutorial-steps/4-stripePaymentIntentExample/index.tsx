...
export function stripePaymentIntentExample(
  ...
  onFirstNameChange: (e: React.ChangeEvent) => void,
  data: Store,
  onLastNameChange: (e: React.ChangeEvent) => void,
  onAddressOneChange: (e: React.ChangeEvent) => void,
  onAddressTwoChange: (e: React.ChangeEvent) => void,
  onZipCodeChange: (e: React.ChangeEvent) => void,
  onEmailChange: (e: React.ChangeEvent) => void,
  onPhoneChange: (e: React.ChangeEvent) => void,
  onCityChange: (e: React.ChangeEvent) => void,
  onStateCodeChange: (e: React.ChangeEvent) => void,
