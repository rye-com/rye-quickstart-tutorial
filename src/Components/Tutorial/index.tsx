...
import type { getAnalyticsUtils } from '../../shared-analytics/getAnalyticsUtils';
...
export default function Index({ analytics }: { analytics: ReturnType<typeof getAnalyticsUtils> }) {
